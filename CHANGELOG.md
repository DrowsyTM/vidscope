...
### Added
- Standard FastMCP server implementation over standard I/O (`video-analyzer mcp`).
- CLI tool powered by Typer (`video-analyzer analyze-video`) with JSON envelope emissions and logging flags (`--verbose`, `--quiet`).
